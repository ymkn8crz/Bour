...
const central = {
  ...
  teams:[
    // 阪神
    {
      ...
      image: require('~/assets/logo_t_l.gif'),
    },
    // 読売
    {
      id: 2,
      ...
      memo: '日本で一番優勝回数の多いセリーグ球団。9年連続優勝したこともある。常にスター選手を輩出している。東京ドームはホームランが出やすいため、どんなホームランでも「ドームラン」と言われている。',
      image: require('~/assets/logo_g_l.gif'),
    },
    // ヤクルト
    {
      id: 3,
      ...
      image: require('~/assets/logo_s_l.gif'),
    },
    // 中日
    {
      id: 4,
      ...
      memo: '高い投手力と守備力が武器のセリーグ球団。バンテリンドームナゴヤはマウンドが硬いため、投手が実力を発揮しやすい構造になっている。マスコットのドアラはバク転が得意。',
      image: require('~/assets/logo_d_l.gif'),
    },
    // 広島
    {
      id: 5,
      ...
      image: require('~/assets/logo_c_l.gif'),
    },
    // DeNA
    {
      id: 6,
      ...
      image: require('~/assets/logo_db_l.gif'),
    },
  ]
}
